        ...
        <header className="border-b border-[#98BEDC]/20 bg-white/85 backdrop-blur-xl sticky top-0 z-40">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              <a href="#quote" className="hidden md:inline-flex rounded-xl bg-[#98BEDC] px-5 py-3 text-sm font-black text-[#325B94] shadow-[0_12px_28px_rgba(50,91,148,0.18)]">
                Get Free Quote
              </a>
              <a
          ...
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a href="#quote" className="inline-flex items-center justify-center rounded-2xl bg-[#98BEDC] px-6 py-4 text-base font-black text-[#325B94] shadow-[0_18px_38px_rgba(50,91,148,0.18)] transition hover:-translate-y-0.5">
                  Get Free Quote
                </a>
            ...
            <div className="rounded-[2rem] border border-[#98BEDC]/30 bg-gradient-to-br from-[#17345f] via-[#274a78] to-[#325B94] p-6 text-white shadow-[0_26px_60px_rgba(15,34,64,0.24)]">
              <div className="rounded-[1.5rem] border border-white/10 bg-white/10 p-5 backdrop-blur-sm">
                <img src="/logo.png" className="mx-auto h-24 w-auto" alt="Paint Pals Logo" />
