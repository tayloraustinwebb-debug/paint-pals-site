...
export default function PaintPalsWebsite() {
  ...
  const beforeAfterPairs = useMemo(
    () => [
      { title: "Cabinet Refinishing Rancho Cucamonga - Dated Stain to Daring Blue", before: "/Before 1.jpg", after: "/After 1.jpeg" },
      { title: "Kitchen Update Riverside - Old Cherry to Yellow & Airy", before: "/Before 2.jpg", after: "/After 2.jpeg" },
      { title: "Cabinet Refinishing San Bernadino - From the Light to the Dark Side", before: "/Before 3.jpeg", after: "/After 3.jpeg" },
    { title: "Kitchen Refinishing Fontana - Damaged and Faded to Facory new White", before: "/Before 4.JPG", after: "/After 7.jpg" },
    ],
    []
  );
