      ...
      <div className="bg-[radial-gradient(circle_at_top_left,rgba(152,190,220,0.18),transparent_28%),radial-gradient(circle_at_top_right,rgba(50,91,148,0.12),transparent_24%)]">
        ...
        <section className="mx-auto max-w-6xl px-4 py-14 md:py-20">
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            ...
            <div className="relative flex justify-center items-center mt-2 md:mt-4 mb-6 md:mb-8">
  <img
    src="/logo.png"
    className="w-[240%] md:w-[280%] max-w-none h-auto object-contain"
    style={{ filter: "drop-shadow(0 30px 70px rgba(152,190,220,0.6))" }}
    alt="Paint Pals Logo"
  />
</div>
